...
public class ScreenViewTest extends Assertions {
    ...
    void clear() {
        ...
        //then
        Mockito.verify(graphics, times(1)).setBackgroundColor(TextColor.Factory.fromString("#1E1E1E"));
        Mockito.verify(graphics, times(1)).fillRectangle(new TerminalPosition(0, 0), new TerminalSize(50,50),' ');
    }
