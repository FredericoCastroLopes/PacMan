...
import com.aor.hero.viewer.screens.InformationScreen;
...
public class InformationScreenTest extends Assertions {
    ...
    String path = "/src/test/resources/InformationTest.txt";
    @BeforeEach
    void init(){
    ...
    public void getSize() {
        ...
        assertEquals(new TerminalSize(41, 26), informationScreen.getSize());
    }
}
